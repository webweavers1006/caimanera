/**
 * 20260901000000_delivery-omit-permission.seed.js
 *
 * Creado: 2026-09-01T00:00:00.000Z
 * Uso:    node prisma/seed --only=20260901000000_delivery-omit-permission
 */

exports.name = '20260901000000_delivery-omit-permission'

const { helpers } = require('./_runner')
const DATA_FILE = '20260901000000_delivery-omit-permission.json'

/** @param {import('@prisma/client').PrismaClient} prisma */
exports.run = async (prisma, log) => {
  const data = helpers.loadData(DATA_FILE)
  log.info('📌 delivery-omit-permission…')
  ...
  // Assign all to ADMIN (admin-only permission)
