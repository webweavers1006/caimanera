...
function AttachmentTrigger({
  ...
  // When href is provided, render as a native anchor link with hover feedback
  if (href != null) {
    return (
      <a
        ...
        className={cn(
          ...
          "transition-colors hover:bg-muted/20 focus-visible:ring-2 focus-visible:ring-ring",
          className
        )}
        {...props}
      />
  ...
  // Fallback: render as button (original behavior for dialogs, actions, etc.)
